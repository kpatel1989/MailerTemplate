...
//			break;
//				case "fontFamily":
//				this.$el.css({"font-family":data.value});
//				console.log(data.value);	
//			break;
//				case "fontSize":
//				this.$el.css({"font-size":data.value});
//				console.log(data.value);	
//			break;
//				case "fontWeight":
//				this.$el.css({"font-weight":data.value});
//				console.log(data.value);	
//			break;
//				case "lineHeight":
//				this.$el.css({"line-height":data.value});
//				console.log(data.value);	
//			break;
//				case "textAlign":
//				this.$el.css({"font-color":data.value});
//				console.log(data.value);	
//			break;
//				default:
//				console.log('default');
